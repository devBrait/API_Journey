...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        public static string DateEndTrip {
            get {
                return ResourceManager.GetString("DateEndTrip", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string DateStartTrip {
            get {
                return ResourceManager.GetString("DateStartTrip", resourceCulture);
            }
        }
